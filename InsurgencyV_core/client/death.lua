...
function InitDeathHandler()
    Citizen.CreateThread(function()
        ...
        Citizen.CreateThread(function()
            ...
            while true do
                ...
                if isDead then
                    ...
                    if count > 800 and isDead then
                        Respawn()
                        count = 0
                    else
                        RageUI.Text({message = "You are dead, you have to wait befor respawn or wait a medic ..."})
                    end
                    Wait(1)
                else
        ...
        function Respawn()
            ...
            SetCamCoord(deathCam, player.coords.x+10.0, player.coords.y+15.0, player.coords.z+15.0)
            PointCamAtCoord(deathCam, player.coords)
            RenderScriptCams(1, 1, 2500, 0, 0)
